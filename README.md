...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=800&color=39FF14&center=true&vCenter=true&width=600&lines=whoami;security+researcher+%2F+builder;recon+%E2%86%92+validate+%E2%86%92+report;initializing+profile..." alt="Typing SVG" />
...
┌─[ boot sequence ]───────────────────────────────────────────┐
│ user@github: rts387                                          │
│ role       : Security Researcher · Bug Bounty · Builder      │
│ status     : [ONLINE]                                        │
└───────────────────────────────────────────────────────────┘
```
